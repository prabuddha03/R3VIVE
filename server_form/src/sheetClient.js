...
export const COM_SHEET_ID = "149J6TbwJs5_psBFYRYKbxwRrsZopA62JvRRmfZpdbwE";

const Comclient = new google.auth.JWT(
...
const Comsheets = google.sheets({
    version: "v4",
    auth: Comclient,
  });
  
  export default Comsheets;